...
**Next up:** AutoCode frontend (✦ button, progress toast, report modal, proposed badges); WKWebView integration; analysis page React island; cross-session moderator linking; snap store publishing. See `TODO.md` for full task list.
