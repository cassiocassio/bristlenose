...
## Current status (v0.13.5, Mar 2026)

Core pipeline published to PyPI + Homebrew + Snap. Latest: **Render refactor** — `render_html.py` broken into `bristlenose/stages/s12_render/` package (8 submodules). Static render formally deprecated. 1938 Python tests, 1070 Vitest tests. React migration complete (Steps 1–10). See `CHANGELOG.md` and git log for full history.
