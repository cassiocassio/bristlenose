...
- **Adding a whole new language = 6 JSON files + 10 registration sites across THREE surfaces (web, Python, native Swift).** Create `bristlenose/locales/<code>/` with all 6 namespace files (`common, desktop, enums, preflight, server, settings`), then register the code in all of:  
