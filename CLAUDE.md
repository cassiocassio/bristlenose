...
- **macOS BSD `find -regextype` doesn't exist** (subset of the BSD/GNU userland gotcha below) — when scripting cross-platform shell, use `find ... -name "*.ext" -print | grep -E pattern` not `find ... -regex`
