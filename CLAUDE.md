...
**Codebook:** `docs/design-codebook-norman.md` (**read before rewording any framework tag** — the decision register, the evidence policy for data that cannot be cited, and the harness; a decision there is reopened by a witness quote that fails, never by a hunch), `docs/design-codebook-v2.md` (the navigator that ships), `docs/design-codebook-state-model.md` (what the enable/disable switch means — the canonical spec), `docs/design-codebook-library.md`, `docs/design-codebook-focus.md`, `docs/design-moderator-question-pill.md`, `docs/design-dynamic-codebook-builder.md`. The v1 island's decision log is history: `docs/archive/design-codebook-island.md`
