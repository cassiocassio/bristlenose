...
| Locale parity | `i18n-check.yml` validates key coverage across 21 full locales (+ the `zh-Hant-HK` override fork), non-strict — missing keys are warnings, not failures |
