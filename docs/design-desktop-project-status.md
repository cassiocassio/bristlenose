...
12 Sep 2026 only the sidecar's bounded fetch and the `cloud_fetch` failure category are built —
"fetching" and "still fetching" have no channel yet. The 30-minute row matches
