...
| `anthropic` | core | `>=1.0` _(was `<1,>=0.39` until 5 Sep 2026)_ | `0.125.0` | `0.125.0` | `1.3.0` | `>=3.9` | `>=3.10` | floor-only since 5 Sep 2026; sidecar carries 1.4.0 |
...
| `mcp` | dev | `>=2.0` _(was `<2.1,>=2.0` until 5 Sep 2026)_ | `2.0.0` ⚠︎ | `2.0.1` ⚠︎ | `2.1.1` | `>=3.10` | `>=3.10` | floor-only since 5 Sep 2026; sidecar carries 2.1.1 |
...
| `mcp-types` | transitive | `—` | `2.0.0` ⚠︎ | `2.0.1` ⚠︎ | `2.1.1` | `>=3.10` | `>=3.10` | pinned `==` by mcp; moves with it (2.1.1 in the sidecar since 5 Sep 2026) |
