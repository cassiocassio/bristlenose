...
| 3 | **Value drift** | `en` reworded; translations keep the old words | **nothing** — the key is present on both sides, and the gate diffs key *sets* |
