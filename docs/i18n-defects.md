...
**Question F — the head noun for a lens, and 訊號.** The Signals rename made
`help.guide.signalsBody` / `help.signals.intro` the first strings to render the
word *lens* (item 21). The seeds use Apple's measured View noun with the lens
