...
4. **Row 39 — the remaining orphans.** 145 leaves sit excused in `_KNOWN_ORPHANS`.
   Deletion is safe now the gate exists and pins leaves rather than counts.
5. **Decisions 2, 4 and 5** (rows 4, 6, 16) — three small calls, each unblocking a
   small change.
