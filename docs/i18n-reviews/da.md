# Bristlenose — Danish wording check
...
**Context you should have: nobody has ever reviewed the Danish.** It was machine-seeded and is one of nine locales shipping that way, so this is the first native read rather than a confirmation pass.

## The five new strings

```
Indlæser signaler…
Ingen signaler endnu. Kør pipelinen, eller anvend kodebogstags for at generere signaler.
Fejl i tag-signaler: {{error}}
Signaler er statistisk bemærkelsesværdige koncentrationer af stemning inden for rapportens afsnit. Stærke og moderate signaler viser, hvor deltagernes oplevelse klumper sig sammen.
Signaler er statistisk bemærkelsesværdige koncentrationer af stemning eller kodebogstags inden for rapportens afsnit. To typer signalkort.
```
...
- **kodebogstags / tag-signaler** — these compound freely in your language, which is why this locale
...
- **Intensity tooltip** — «Gennemsnitlig følelsesmæssig intensitet (1–3)». The range said 0–3 in every language
