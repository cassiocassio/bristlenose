# Bristlenose — Dutch wording check
...
**Context you should have: nobody has ever reviewed the Dutch.** It was machine-seeded and is one of nine locales shipping that way, so this is the first native read rather than a confirmation pass.

## The five new strings

```
Signalen laden…
Nog geen signalen. Voer de pijplijn uit of pas codeboektags toe om signalen te genereren.
Fout in tagsignalen: {{error}}
Signalen zijn statistisch opvallende concentraties van sentiment binnen rapportsecties. Sterke en gematigde signalen laten zien waar de ervaring van deelnemers samenklontert.
Signalen zijn statistisch opvallende concentraties van sentiment of codeboektags binnen rapportsecties. Twee soorten signaalkaart.
```
...
- **codeboektags / tagsignalen** — these compound freely in your language, which is why this locale
...
- **Intensity tooltip** — «Gemiddelde emotionele intensiteit (1–3)». The range said 0–3 in every language
