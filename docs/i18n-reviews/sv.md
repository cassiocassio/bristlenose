# Bristlenose — Swedish wording check
...
**Context you should have: nobody has ever reviewed the Swedish.** It was machine-seeded and is one of nine locales shipping that way, so this is the first native read rather than a confirmation pass.

## The five new strings

```
Läser in signaler…
Inga signaler ännu. Kör pipelinen eller tillämpa kodbokstaggar för att generera signaler.
Fel i taggsignaler: {{error}}
Signaler är statistiskt märkbara koncentrationer av sentiment inom rapportens avsnitt. Starka och måttliga signaler visar var deltagarupplevelsen klustrar sig.
Signaler är statistiskt märkbara koncentrationer av sentiment eller kodbokstaggar inom rapportens avsnitt. Två typer av signalkort.
```

## Where I'd value your steer

### The copula sentence is mine  ·  low risk, but unread
- The definition sentence puts **är** in front of your existing clause, which
...
- **kodbokstaggar / taggsignaler** — these compound freely in your language, which is why this locale
...
- **Intensity tooltip** — «Genomsnittlig känslointensitet (1–3)». The range said 0–3 in every language
