...
- **Status:** correctness slice merged 10 May 2026 (`spa-pipeline-completion-refetch`) — auto-refetch within ~3 s of completion + race-safe import-then-publish. Trust-UX polish (refresh button, skeleton, empty-state mounts, cross-island contract test) follows in `pipeline-completion-trust-ux`
