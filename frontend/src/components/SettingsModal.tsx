...
const CONFIG_DATA: SettingCategory[] = [
  ...
  },
  {
    ...
    settings: [
      ...
      { labelKey: "configReference.settings.quotes.quoteSequenceGap", envVar: "SEQUENCE_GAP_SECONDS", default: "17.5", file: "models.py", filePath: "bristlenose/signals/models.py", options: ["seconds"] },
  ...
  },
  {
    ...
    settings: [
      { labelKey: "configReference.settings.analysis.topNSignals", envVar: "DEFAULT_TOP_N", default: "12", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.topNSignalsGeneric", envVar: "DEFAULT_TOP_N", default: "12", file: "generic_detect.py", filePath: "bristlenose/signals/generic_detect.py" },
      ...
      { labelKey: "configReference.settings.analysis.minQuotesPerCell", envVar: "MIN_QUOTES_PER_CELL", default: "2", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.strongConcentration", envVar: "hardcoded", default: "2", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.strongParticipants", envVar: "hardcoded", default: "5", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.strongQuotes", envVar: "hardcoded", default: "6", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.moderateConcentration", envVar: "hardcoded", default: "1.5", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.moderateParticipants", envVar: "hardcoded", default: "3", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
      { labelKey: "configReference.settings.analysis.moderateQuotes", envVar: "hardcoded", default: "4", file: "detect.py", filePath: "bristlenose/signals/detect.py" },
    ],
  },
  {
    id: "autocode",
