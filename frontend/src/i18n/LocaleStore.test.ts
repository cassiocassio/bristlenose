...
vi.mock("./index", () => {
  ...
  return {
    ...
    SUPPORTED_LOCALES: ["en", "es", "ja", "fr", "de", "ko", "it", "pl", "ru", "uk", "da", "sv", "nb", "tr", "nl", "fi", "pt-BR", "pt-PT", "zh-Hant", "zh-Hant-HK"],
    isSupportedLocale: (v: unknown) =>
      typeof v === "string" &&
      ["en", "es", "ja", "fr", "de", "ko", "it", "pl", "ru", "uk", "da", "sv", "nb", "tr", "nl", "fi", "pt-BR", "pt-PT", "zh-Hant", "zh-Hant-HK"].includes(v),
