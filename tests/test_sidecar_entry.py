...
class TestSidecarPassthroughAllowlist:
    ...
    def test_passthrough_set_is_doctor_only(self) -> None:
        """The allowlist of subcommands the bundled binary accepts (other
        than the implicit "serve" rewrite) is exactly {"doctor"}.
        ...
        sidecar's surface area. If you intend to add a new subcommand:
          ...
          2. Confirm the subcommand is read-only or sandbox-safe.
        ...
        assert sidecar_entry._PASSTHROUGH_COMMANDS == {"doctor"}, (
